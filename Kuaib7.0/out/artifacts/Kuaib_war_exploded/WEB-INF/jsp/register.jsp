...
<%--上方logo显示--%>
<div id="bottom-logo" style="background: #4B63BB;width: 85em;height: 3.6875em;text-align: center;font-weight: bold">
    ...
    <div>
        <form id="doregister" action="${pageContext.request.contextPath}/adduser.html" method="post">
            <h1 style="margin-top:2.375em;text-align: center;color: #4B63BB;font-size: 1.6875em;">用户注册</h1>
            <div>
                <input type="hidden" id="path" name="path" value="${pageContext.request.contextPath}"/><%--存放绝对路径，便于ajax访问--%>
                <input style="background: #EFFFB4;" type="text" id="userCode" placeholder="用户名" name="userCode">
                <!-- 放置提示信息 -->
                <span color="red"></span>
            </div>
            <div>
                <input style="background: #EFFFB4;" type="email" id="email" placeholder="邮箱" name="email">
                <!-- 放置提示信息 -->
                <span color="red"></span>
            </div>
            <div>
                <input style="background: #EFFFB4;" type="password" id="userPassword" autocomplete="new-password" placeholder="密码" name="userPassword">
                <!-- 放置提示信息 -->
                <span color="red"></span>
            </div>
            <div>
                <input style="background: #EFFFB4;" type="password" id="ruserPassword" autocomplete="new-password" placeholder="确认密码" name="ruserPassword">
                <!-- 放置提示信息 -->
                <span color="red"></span>
            </div>
