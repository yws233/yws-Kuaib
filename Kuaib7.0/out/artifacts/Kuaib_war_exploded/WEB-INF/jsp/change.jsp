...
<%--选课提交信息--%>
<h1 style="text-align: center;color: white;background: #4B63BB;line-height: 1.6875em">信息交换系统&nbsp;&nbsp;<a style="font-size: 16px;color: white;" href="${pageContext.request.contextPath}/sys/user/backmain.html"><< 返回首页</a></h1>
<%--抽取导师--%>
<div class="roll-area" >
...
<div style="background:white;display:inline-block;border: 1px solid #8FB5E8;width: 400px;height: auto;text-align: center;margin-left: 4em">
    <%--提交表单--%>
    ...
    <form action="${pageContext.request.contextPath}/sys/user/exadd.html" method="post">
        ...
        <a style="font-size: 1.125em;font-weight:bold; font-family:文泉驿微米黑;text-decoration: none;list-style: none" href="${pageContext.request.contextPath}/sys/user/exsave.html">查看</a>
        <%--提交成功提示框--%>
...
<div style="border: 1px solid #8FB5E8;width: 600px;height: auto;text-align: center;margin: 0 auto">
    <table style="margin: 0 auto">
        <tr style="margin: 0 auto;display: inline-block">
            <td style="color: #4B63BB; text-align:center;display: inline-block;margin-right: 4em">编码<br></td>
            <td style="color: #4B63BB; text-align:center;display: inline-block;margin-right: 4em">昵称<br></td>
            <td style="color: #4B63BB; text-align:center;display: inline-block;margin-right: 4em">导师<br></td>
        ...
        <c:forEach var="change" items="${exList}" varStatus="status">
            <tr style="margin: 0 auto;display: inline-block">
                <td style=" text-align:center;display: inline-block;margin-right: 4em"><span>${change.exid}</span> <%--编码--%></td>
                <td style=" text-align:center;display: inline-block;margin-right: 4em"><span>${change.exname}</span> <%--昵称--%></td>
                <td style=" text-align:center;display: inline-block;margin-right: 4em"><span>${change.exteacher}</span> <%--导师--%></td>
                <td style=" text-align:center;display: inline-block;margin-right: 4em"><span>${change.exphone}</span> <%--电话--%></td>
            </tr>
        </c:forEach>
       <%-- <tr style="margin: 0 auto;display: inline-block">
            <td ><span>1</span></td>
            <td style="text-align:center;display: inline-block;margin-right: 4em"><span>2</span></td>
            <td style="text-align:center;display: inline-block;margin-right: 4em"><span>3</span></td>
        </tr>--%>
    </table>
</div>
