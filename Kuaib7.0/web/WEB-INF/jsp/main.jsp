        ...
        <div class="middle" style="background: white;margin-top: 10px;height: 480px;box-shadow:  1px 2px 2px #C1C1C1;">
            ...
            <form action="${pageContext.request.contextPath}/sys/user/savetext.html?uid=${userSession.uid}" method="post" enctype="multipart/form-data">
                 <textarea id="txt-more" <%--class="xheditor"--%> class="xheditor-mfull" rows="17" cols="90" style="margin: 0px;height: 340px;width: 100%;box-shadow: none" name="txt-more">
                   <span style="font-size: 15px;font-family: '微软雅黑', 'Helvetica Neue', Arial, sans-serif">${wangtext}</span>
                     <%--返回文本信息--%>
                 </textarea>
                <textarea id="status" name="status" onkeydown='countChar("status","counter");' onkeyup='countChar("status","counter");'>实时计数编辑区域...</textarea>
